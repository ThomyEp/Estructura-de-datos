 ...
 * @author alumnos
 */
public class frmGestionarEmpleados extends javax.swing.JFrame {
    ...
    public frmGestionarEmpleados() {
        initComponents();
        this.setLocationRelativeTo(frmGestionarEmpleados.this); //centra la ventana
